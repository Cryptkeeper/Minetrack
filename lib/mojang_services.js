...
exports.toApiMessage = function() {
	var apiData = [];
	// Quick workaround to access our object without having to specify the URL as the key.
 	Object.keys(serviceStates).forEach(function(k) {
   	var v = serviceStates[k];
 		apiData.push(v);
 	}); 	
	return apiData;
}