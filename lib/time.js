...
class TimeTracker {
  ...
  static getDisplayedMaxGraphLength () {
    if (typeof config.defaultDisplayedGraphDuration === 'number') {
      return Math.ceil(config.defaultDisplayedGraphDuration / GRAPH_UPDATE_TIME_GAP)
    }
    return TimeTracker.getMaxGraphDataLength()
  }
